...
def validate_docx_workflow_input(conn, payload: DocxWorkflowRunIn) -> list[dict]:
    ...
    asset_ids = [
        ...
        payload.fit_front_asset_id,
        payload.fit_side_asset_id,
...
def insert_project_workflow_steps(conn: sqlite3.Connection, project_id: str, payload) -> None:
    ...
    steps = build_workflow_steps(
        ...
        fit_front_asset_id=payload.fit_front_asset_id,
    ...
    with get_db() as conn:
        ...
        conn.execute(
            """UPDATE projects SET
               ...
               product_asset_id = ?, model_asset_id = ?, fit_front_asset_id = ?, fit_side_asset_id = ?, fit_back_asset_id = ?, scene_asset_id = ?, pose_asset_id = ?,
            ...
            (
                ...
                payload.scene_asset_id, payload.pose_asset_id,
